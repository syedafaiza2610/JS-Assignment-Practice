...
// var prof = "Mern Stack Developer"
// var country = " USA"
// var marry = "ABC"
// var child = "2 Kids"
// alert("You will be a "+ prof + "in" + " " + country + ", married with" +" " + marry + " " +"and have"+" " + child)
...
//  var email = "syedafaiza2610@gmail.com"
...
// var uni = "University of Karachi";
// var course = "Mern Stack Developer";
// alert("My name is" + " " + myName + " " + "I am" + " " + age + " " + "years old" + " " + "I Study in" + " "+ uni + " " + "I am a" +" "+ course )
...
// var year = 1997;
// document.write("My birth year is" + " " + year + "<br>" +"Data type of my declared variable is number ")
